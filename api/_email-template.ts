...
export type EmailTemplateOptions = {
  ...
  note?: string;            // small security/reassurance note
  outro?: string;           // closing paragraph
};
...
<body style="margin:0;padding:0;background:${PAGE_BG};">
  ...
  if (o.outro) { lines.push(''); lines.push(o.outro); }
  lines.push(''); lines.push('Warm regards,'); lines.push('The Way Team');
  lines.push(''); lines.push('theway.ge · info@theway.ge');
